...
public class Transcript {
     ...
     * returns a new list with timeregions consisting of sentences
     *
     * TODO there will be overlaps when sentences stop in the middle of a timeregion, consider putting in an approximate end time
    ...
    public boolean isAutoGenerated() {
        ...
        if (isAutoGenerated == null) {
            ...
            if (proportionOfPunctuation >= Constants.DEFAULT_SUMMARY_PROPORTION) {
