...
public class Transcript {
    ...
    public String isAutoGenerated() {
        String transcript = this.entireTranscript;
        StringBuilder toReturn = new StringBuilder();
        toReturn.append("Original Transcript: ").append(transcript).append("\n\n");
        int originalLength = transcript.length();
        toReturn.append("Original Length: ").append(transcript.length()).append("\n\n");
        String withoutPunctuation = transcript.replaceAll("\\p{Punct}", "");
        int newLength = withoutPunctuation.length();
        toReturn.append("New Transcript: ").append(withoutPunctuation).append("\n\n");
        toReturn.append("New Length: ").append(withoutPunctuation.length()).append("\n\n");
        toReturn.append("percentage of punctuation: ").append(((originalLength - newLength) * 1.0) / originalLength);
